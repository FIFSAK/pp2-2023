...
pause = pygame.image.load(
    r'C:\PyCharm Community Edition 2022.3.1\python proj\tsis9\images\Pause-PNG-Image-Transparent.png')
start = pygame.image.load(
    r'C:\PyCharm Community Edition 2022.3.1\python proj\tsis9\images\Play-Button-Transparent-Image.png')
